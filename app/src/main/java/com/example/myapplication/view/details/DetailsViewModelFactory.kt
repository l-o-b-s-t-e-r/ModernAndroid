...
class DetailsViewModelFactory @Inject constructor(private val showLastUserUseCase: ShowLastUserUseCase,
                                                  private val hideFirstUserUseCase: HideFirstUserUseCase) :
    ViewModelProvider.Factory {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DetailsViewModel::class.java)) {
            return DetailsViewModel(showLastUserUseCase, hideFirstUserUseCase) as T
        }
