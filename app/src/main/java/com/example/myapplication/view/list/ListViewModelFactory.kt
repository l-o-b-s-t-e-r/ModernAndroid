...
class ListViewModelFactory @Inject constructor(private val getAllUsersUseCase: GetAllUsersUseCase,
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ListViewModel::class.java)) {
            return ListViewModel(getAllUsersUseCase, loadAndSaveAllUsersUseCase, updateUserColorUseCase, getAllUsersPerPageUseCase, getAllUsersPerPageByNameUseCase, userDataSourceFactory) as T
        }
